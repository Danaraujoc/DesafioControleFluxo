...
public class Contador {
    public static void main(String[] args) {
        ...
        // Utilizando o laço de repetição while para reiniciar a aplicação caso ocorra a
        // exceção
    ...
    static void contar(int parametroUm, int parametroDois) throws ParametrosInvalidosException {
        ...
        System.out.println("A interação obteve: " + contagem + " ocorrência de acordo com os parâmetros passados");
    }
}